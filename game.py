...
HELPER_DELAY = 0.1#001  # this delay is to give the code a 1ms bump after printing the board in hopes of getting rid of the jittery visuals
VISUAL_DELAY = 0.1#0001
